...
public class kakaoAPIService {
	...
	public kakaoAccessTokenWeapper getAccessToken(String code) {
		// 콜백으로 받은 인증코드를 이용해서 카카오에서 유저를 받아와 야함
		...
		ResponseEntity<kakaoAccessTokenWeapper> result =
				template.postForEntity(tokenURL, entity, kakaoAccessTokenWeapper.class);
